    ...
    <main className='min-lg:w-1/3 min-md:h-2/3 items-center justify-center'>
      {canCreateCompanion ? (
        ...
        <article className='companion-limit'>
          ...
          <p>You're reached your companion limit. Upgrade to create more companions and premium freatures.</p>
          <Link href='/subscription'>
            <button className='btn-primary w-full justify-center'>Upgrade My Plan</button>
          </Link>
        </article>
      )}
    </main>
